package com.sg.cj.common.base.view.indicator;
...
import com.sg.cj.common.base.view.indicator.Indicator.IndicatorAdapter;
import com.sg.cj.common.base.view.indicator.Indicator.OnTransitionListener;
import com.sg.cj.common.base.view.indicator.slidebar.ScrollBar;
import com.sg.cj.common.base.view.viewpager.RecyclingPagerAdapter;
  ...
  protected void iniOnItemSelectedListener() {
    indicatorView.setOnItemSelectListener(new Indicator.OnItemSelectedListener() {
      ...
      public void onItemSelected(View selectItemView, int select, int preSelect) {
        if (viewPager instanceof SgViewPager) {
          viewPager.setCurrentItem(select, ((SgViewPager) viewPager).isCanScroll());
        } else {
