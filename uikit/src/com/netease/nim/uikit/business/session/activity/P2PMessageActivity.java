...
import com.netease.nim.uikit.common.util.IsBang;
...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private LinearLayout back,llTop;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        back = (LinearLayout)findView(R.id.heard_back);
...
//        IsBang.setImmerHeard(this,llTop);
        ImmersionBar.with(this).statusBarColor(R.color.app_red).init();
