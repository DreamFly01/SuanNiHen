...
//        setBoomMenu();
                ...
                switch (view.getId()) {
                    case R.id.ll_item1:
                        ...
                        if (linkUrl.contains("http")) {
                            ...
                            JumpUtils.dataJump(StoreDetailsActivity.this, ProtocolActivity.class, bundle, false);
                        }
                        break;
                    case R.id.ll_item2:
    ...
    private void getData() {
        ...
        RequestClient.GetSuperMarketCommTenant(id, "", this, new NetSubscriber<BaseResultBean<SupplierBean>>(this) {
            @Override
            public void onResultNext(BaseResultBean<SupplierBean> model) {
                ...
                EventBus.getDefault().postSticky("storeFollow");
                isClick = bean.IsFavorite;
                ImageUtils.loadUrlImage(StoreDetailsActivity.this, model.data.SupplierIcon, ivLogo);
                tvName.setText(model.data.SupplierName);
                tvAddress.setText(model.data.Address);
                tvFuwu.setText("到店自取");
                tvIntroduce.setText("无");
...
//            recLeft.addItemDecoration(new DividerItemDecoration(mContext, DividerItemDecoration.VERTICAL));
    ...
    @OnClick({R.id.heard_back, R.id.tv_pay, R.id.iv_shop_logo, R.id.ll_follow, R.id.heard_title, R.id.heard_menu, R.id.tv_sp, R.id.tv_xx})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.heard_title:
                ...
                JumpUtils.dataJump(StoreDetailsActivity.this, SearchProductActivity.class, bundle, false);
                break;
            case R.id.heard_menu:
                ...
                break;
            case R.id.tv_sp:
                tvSp.setTextColor(Color.parseColor("#2A2A2A"));
            ...
            case R.id.tv_xx:
                ...
                tvXx.setTextColor(Color.parseColor("#2A2A2A"));
...
//                        bean.CommTenantResultList.get(i).CommTenantList.get(k).total = 0;
        ...
        initData(bean);
        initLeft(StoreDetailsActivity.this);
        initRight(StoreDetailsActivity.this);
        setBoomMenu();
        avi.setVisibility(View.GONE);
    }
    ...
    private void jump(Map<String, String> map, int type) {
        if (type == 1) {
            ...
            if (map.get("storeType").equals("6")) {
                JumpUtils.dataJump(StoreDetailsActivity.this, StoreDetailsActivity.class, bundle, false);
            } else {
                JumpUtils.dataJump(StoreDetailsActivity.this, ProductDetailsActivity.class, bundle, false);
            }
            ...
            if (map.get("storeType").equals("6")) {
                ...
                JumpUtils.dataJump(StoreDetailsActivity.this, ShopDetailsActivity.class, bundle, false);
