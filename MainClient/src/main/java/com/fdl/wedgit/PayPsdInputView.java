 ...
 * <p>desc：<p>
 * <p>author：DreamFly<p>
 * <p>creatTime：2018/11/10<p>
 * <p>changeTime：2018/11/10<p>
 * <p>version：1<p>
 */
...
public class PayPsdInputView extends EditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_radiuss, radius);
...
//       super.onDraw(canvas);
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (textLength == maxCount) {
            if (mListener != null) {
                if (StrUtils.isEmpty(mComparePassword)) {
                    mListener.inputFinished(getPasswordString());
                } else {
                    if (mComparePassword.equals(getPasswordString())) {
