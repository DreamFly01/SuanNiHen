...
import com.sg.cj.snh.view.citypicker.adapter.CityListAdapter;
import com.sg.cj.snh.view.citypicker.adapter.InnerListener;
import com.sg.cj.snh.view.citypicker.adapter.OnPickListener;
import com.sg.cj.snh.view.citypicker.adapter.decoration.DividerItemDecoration;
import com.sg.cj.snh.view.citypicker.adapter.decoration.SectionItemDecoration;
import com.sg.cj.snh.view.citypicker.db.DBManager;
...
import com.sg.cj.snh.view.citypicker.util.ScreenUtil;
...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImmersionBar.with(this).titleBar(search).init();
        initData();
        initViews();
    }
    ...
    private void initViews() {
        ...
        search = mContentView.findViewById(R.id.cp_search_view);
        IsBang.setImmerHeard(getContext(),search);
...
//        dbManager.setAllCities(mAllCities);
        mAllCities.add(0,new City("全国",""));
        mAllCities.add(1, mLocatedCity);
